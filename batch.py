...
from extract import DEFAULT_RPM_BUDGET, DEFAULT_TPM_BUDGET, ExtractionError, extract_contract_chunked
...
def analyze_batch(
    ...
    `api_key`, when given, is used for every document instead of
    GEMINI_API_KEY from the environment -- see extract._get_client.
    """
    ...
    for index, path in enumerate(file_paths, start=1):
        ...
        result = analyze_one(path, limiter=limiter, progress_callback=on_chunk, api_key=api_key)
